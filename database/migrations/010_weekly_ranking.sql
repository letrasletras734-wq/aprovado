-- Migration 010: Weekly Ranking Function
-- This function calculates ranking based on simulado_results from the last 7 days.
...
BEGIN
    ...
    SELECT 
        p.id,
        COALESCE(p.username, TRIM(p.full_name)) as name,
