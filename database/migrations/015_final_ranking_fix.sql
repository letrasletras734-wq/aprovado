-- Migration 015: Definitive Ranking Fix
-- This fix corrects the column name mismatch (created_at -> completed_at)
-- and ensures the ranking is extremely robust and visible to all.
...
BEGIN
    ...
    -- NO ROLE FILTERS - Show everybody who has a profile
